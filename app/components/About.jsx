...
const about = ({isDarkMode}) => {
  return (
    ...
    <h4
    className='text-center mb-2 text-lg font-Ovo border-b'>Introduction</h4>
    <h2 
    ...
    className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        className="flex-1">
            ...
            >"Hello, I'm Shwet Kheni, a passionate computer science student at Nirma University with a keen interest in Web development and Software development. Explore my portfolio to see how I combine theoretical knowledge with practical skills to create innovative solutions."</p>
            ...
            <h4 
            className='my-6 text-gray-700 font-Ovo dark:text-white/80'>Tools & Platform I use, </h4>
            <ul 
